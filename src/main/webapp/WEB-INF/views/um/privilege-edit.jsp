...
<body>
	<article class="page-container">
		<form action="/rest/um/privilege/edit" method="post" enctype="multipart/form-data" class="form form-horizontal" id="edit-privilege-form">
			<div class="row cl skin-minimal">
				<label class="form-label col-xs-4 col-sm-3">状态：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<div class="radio-box">
						<input type="radio" id="radio-1" name="status" value="1" <c:if test="${user.status == 1}">checked</c:if>>
						<label for="radio-1">启用</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="radio-2" name="status" value="0" <c:if test="${user.status == 0}">checked</c:if>>
	...
	<script type="text/javascript">
		...
		var formId = "edit-privilege-form";
