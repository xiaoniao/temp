...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>系统设置 <span class="c-gray en">&gt;</span> 服务项目 
		...
		<div class="page-container">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
					<a id="travelDesc-add" class="btn btn-primary radius a-facilities-add" data-title="添加服务项目"  href="javascript:;">
						<i class="Hui-iconfont">&#xe600;</i> 添加服务项目
					</a>
				</span>
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20" id="no-data-div">
				<span class="l">&nbsp&nbsp暂无服务项目数据，您可以添加服务项目后再继续查看</span>
			</div>
		</div>
		...
		<script type="text/javascript">
			 ...
			 * 列表数据、分页绑定
			 */
			var queryRowUrl  = "/rest/um/travelDesc/lscount";
			var queryDataUrl = "/rest/um/travelDesc/list";
			var dataListKey = [
				{key:'icon', type:'image', height: 50}, 
				{key:'demand', type:'text'}, 
			...
			var operatHtml = "";
				...
				operatHtml += "<a title=\"编辑\" style=\"color:#0A6999\" href=\"javascript:;\" name=\"travelDesc-edit\" dataKey=\"id\" dataId=\"operatId\"><i class=\"Hui-iconfont Hui-iconfont-edit\"></i>详情</a>";
			
			
			var operatWindows = [];
			
			var editWindow = {};
			editWindow.domName = "travelDesc-edit";
			editWindow.url   = "/rest/um/travelDesc/toEdit";
			editWindow.title = "编辑服务项目";
			 ...
			 */
			var addDomId = "travelDesc-add";
			var addUrl   = "/rest/um/travelDesc/toAdd";
			var addTitle = "添加服务项目";
			var addWidth = 800;
			var addHeight = 500;
			var addType = 'local';
