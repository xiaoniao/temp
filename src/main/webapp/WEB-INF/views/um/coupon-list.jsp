...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>优惠券管理
		...
		<div class="page-container">
			...
			<div class="text-c" style="margin-top: 10px;">
				...
				<input type="text" name="mobile" id="mobile" placeholder="会员账号" style="width:120px" class="input-text">
				<input type="text" name="memberName" id="memberName" placeholder="会员姓名" style="width:120px" class="input-text">

				使用时间
				<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'startUseTime\')||\'%y-%M-%d\'}'})" id="startUseTime" name="startUseTime" class="input-text Wdate" style="width:120px;">
				-
				<input type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'endUseTime\')}',maxDate:'%y-%M-%d'})" id="endUseTime" name="endUseTime" class="input-text Wdate" style="width:120px;">
				...
				<span class="select-box inline" style="padding:0">
					<select name="endDay" id="endDay" class="select input-text help-inline">
						<option value="">-- 到期时间 --</option>
						<option value="15">小于15天</option>
						<option value="30">小于30天</option>
						<option value="60">小于60天</option>
					</select>
				</span>
		...
		<script type="text/javascript">
			...
			* 列表数据、分页绑定
			*/
			var queryRowUrl  = "/rest/um/coupon/listPageCount";
			var queryDataUrl = "/rest/um/coupon/listPage";
			
			var dataListKey = [
				{key:'id', type:'text'},
				{key:'memberName', type:'text'},
				...
				{key:"useDate", type:'text'}
			];
			
			var pagesize = 12;
			var searchInput = ['memberName', 'mobile', 'startUseTime', 'endUseTime', 'status', 'endDay'];
			var operatHtml = "";
			var operatWindows = [];
