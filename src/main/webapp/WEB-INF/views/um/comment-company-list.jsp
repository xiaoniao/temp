...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>对公司的评价
		...
		<script type="text/javascript">
			...
			* 列表数据、分页绑定
			*/
			var queryRowUrl  = "/rest/um/comment/company/listPageCount";
			var queryDataUrl = "/rest/um/comment/company/listPage";

			var dataListKey = [
				{key:'id', type:'text'},
				{key:'bankMobile', type:'text'},
				{key:'content', type:'text'},
				{key:'orderStartDate', type:'text'},
