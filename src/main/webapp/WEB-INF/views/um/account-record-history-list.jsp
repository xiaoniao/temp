...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>历史明细
		...
		<script type="text/javascript">
			...
			* 列表数据、分页绑定
			*/
			var queryRowUrl  = "/rest/um/accountRecord/listPageCount?pageType=history";
			var queryDataUrl = "/rest/um/accountRecord/listPage?pageType=history";
