...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>订单管理 <span class="c-gray en">&gt;</span> 待轮巡订单
		...
		<script type="text/javascript">
			 ...
			 * 列表数据、分页绑定
			 */
			var queryRowUrl  = "/rest/um/order/pendingOrdersCount";
			var queryDataUrl = "/rest/um/order/pendingOrdersList";
			...
			var operatHtml = "";
				...
				operatHtml += "<a class=\"ml-10\" style=\"color:#0A6999\" title=\"订单行程\" href=\"javascript:;\" name=\"order-stroke\" dataKey=\"id\" dataId=\"operatId\"><i class=\"Hui-iconfont Hui-iconfont-gengduo\"></i>详情</a>";
