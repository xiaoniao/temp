...
<body>
	<article class="page-container">
		<form action="/rest/um/costItem/add" method="post" enctype="multipart/form-data" class="form form-horizontal" id="add-costItem-form">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">消费类目名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" id="costName" name="costName" style="width:300px">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="btn-upload form-group">
						<input class="input-text upload-url radius" type="text" readonly  placeholder="图片尺寸50*50px" name="filePath">
