...
<html>
	...
	<body>
		...
		<script type="text/javascript">
			...
			var dataListKey = [
				{key:'img', type:'imageLinkUrl', linkUrl:"javascript:queryDetail(operatId);", height: 50}, 
				{key:'name', type:'text'},
			...
			var operatHtml = "";
				...
				operatHtml += "<a title=\"编辑\" href=\"javascript:;\" name=\"brand-edit\" dataKey=\"id\" dataId=\"operatId\">编辑</a>";
