...
<body>
	<article class="page-container">
		<form action="/rest/um/resourceType/edit" method="post" enctype="multipart/form-data" class="form form-horizontal" id="edit-resource-type-form">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">分类名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="hidden" value="${resourceType.id}" name="id" />
					<input type="text" class="input-text" id="name" name="name" style="width:300px" value="${resourceType.name}">
				</div>
			</div>
			<div class="row cl skin-minimal">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<div class="radio-box">
						<input type="radio" id="radio-1" name="status" value="1" <c:if test="${resourceType.status == 1}">checked</c:if>>
						<label for="radio-1">显示</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="radio-2" name="status" value="0" <c:if test="${resourceType.status == 0}">checked</c:if>>
	...
	<script type="text/javascript">
		...
		var formId = "edit-resource-type-form";
