...
<body>
	<article class="page-container">
		<form action="/rest/um/order/endComplaintOrder" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
			<input type="hidden" name="id" value="${orderId}"/>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">选择退款金额：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<div>
						<input name="refundMethod" type="radio" value="1" class="screening-radio" checked="checked">规则退款
					</div>
					<div>
						<input name="refundMethod" type="radio" value="2" class="screening-radio">全额退款
					</div>
				</div>
			</div>
			<div class="row cl">
