...
<html>
	...
	<body>
		<nav class="breadcrumb">
			<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>资源管理 <span class="c-gray en">&gt;</span> 广告
		...
		<div class="page-container">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
					<a id="banner-add" class="btn btn-primary radius a-facilities-add" data-title="添加广告"  href="javascript:;">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20" id="no-data-div">
				<span class="l">&nbsp&nbsp暂无广告，您可以添加广告后再继续查看</span>
			</div>
		</div>
		...
		<script type="text/javascript">
			 ...
			 * 列表数据、分页绑定
			 */
			var queryRowUrl  = "/rest/um/banner/lscount";
			var queryDataUrl = "/rest/um/banner/list";
			var dataListKey = [
				{key:'image', type:'imageLinkUrl', linkUrl:"javascript:queryDetail(operatId);", height: 50}, 
				{key:'title', type:'text'},	
			...
			editWindow.url   = "/rest/um/banner/toEdit";
			editWindow.title = "编辑广告";
			...
			var addUrl   = "/rest/um/banner/toAdd";
			var addTitle = "添加广告";
			var addWidth = 800;
			var addHeight = 500;
			var addType = 'local';
