...
<body>
	<article class="page-container">
		<form action="/rest/um/resourceType/add" method="post" enctype="multipart/form-data" class="form form-horizontal" id="add-resource-type-form">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2" style="text-align:right">分类名称：</label>
	...
	<script type="text/javascript">
		...
		var formId = "add-resource-type-form";
